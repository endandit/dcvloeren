...
/**
 * MobileWrapperContentCenter
 * 
 * MOBILE ONLY: Identical to tablet center content wrapper with column/vloeren
 * inserted between column/images/2 and column/about
 * Mobile hides left and right wrappers, showing only center content
 */
...
export function MobileWrapperContentCenter({ onIconClick, isClickable, scrollProgress }: { onIconClick?: () => void; isClickable?: boolean; scrollProgress?: number } = {}) {
  // Identical to tablet: bottom -6775px, height 7110px
  return (
    <div className="absolute bottom-[-6775px] h-[7110px] left-1/2 translate-x-[-50%] w-[440px]" data-name="wrapper/content/center">
